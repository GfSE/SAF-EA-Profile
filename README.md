# Sparx Systems Enterprise Architect Repository, TdSE2024 Release
...
# safMDG.xml
System Architecture Framework Profile has been created by the SAF Working Group of the German Chapter of INCOSE (GfSE). The SAF Profile provides the stereotypes, specification views and linking rules according to the [SAF-Specification](https://saf.gfse.org/version/TdSE2024) based on EA's MDG Technology.

# How to use safMDG
Download the safMDG.zip by [entering the zip-file](https://github.com/GfSE/SAF-EA-Profile/blob/TdSE2024/safMDG.zip) in the list and select the download button (Download raw file).
